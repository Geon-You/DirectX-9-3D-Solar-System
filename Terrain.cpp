...
HRESULT Terrain::InitVB()
{
	...
	cxHeight = sd.Width;  // 텍스쳐 가로크기
	czHeight = sd.Height; // 텍스쳐 세로크기
...
void Terrain::Animate()
{
	...
	// y축 회전 행렬
	D3DXMatrixRotationY(&matRot,/* d / 1000.f*/0);
